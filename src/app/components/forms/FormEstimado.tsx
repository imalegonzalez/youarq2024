          ...
          <div className="w-full flex justify-center">
            <div className="max-w-lg">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Usaremos estos datos para ponernos en contacto.
              </p>
        ...
        {currentStep === 2 && (
          <>
            <div className="flex w-full justify-center">
              ...
              />
              {/* <div>Selected Interests: {interests.join(', ')}</div> */}
            </div>
          </>
        )}
      </form>
      ...
      <div className="mt-8 pt-5">
        <div className="flex justify-between">
          <button
            ...
            className="rounded bg-white px-2 py-1 text-sm font-semibold text-sky-900 shadow-sm ring-1 ring-inset ring-sky-300 hover:bg-sky-50 disabled:cursor-not-allowed disabled:opacity-0"
          >
            Volver
            <svg
