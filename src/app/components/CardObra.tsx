  ...
  if (size === "glass") {
    return (
      ...
      >
        ...
        >
          <figure className="relative h-full w-full overflow-hidden flex flex-col justify-between rounded-lg p-2">
            ...
            <img
              ...
              alt={nombreDeObra}
            />
            <div className="bottom-0 py-2 px-3 flex flex-row min-h-16 justify-between items-center bg-white bg-opacity-30 backdrop-blur-sm border border-white border-opacity-20 shadow-lg p-4 rounded-lg">
              <div>
                <h2>{nombreDeObra}</h2>
              </div>
              <div>
  ...
  if (type === "noLink") {
    return (
      <div key={post.sys.id} className="rounded-lg w-full card">
        <figure className="relative h-full min-h-64 w-full overflow-hidden flex flex-col justify-between rounded-lg p-2">
          <p className="text-xs px-3 py-1 m-2 bg-white rounded-full z-10 w-fit">
            {categoria.fields.nombreCategoria}
          </p>
          <img
            ...
            alt={nombreDeObra}
          />
          <div className="bottom-0 py-2 px-3 flex flex-row min-h-16 justify-between items-center bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-20 shadow-lg p-4 rounded-lg">
            <div>
              <h2>{nombreDeObra}</h2>
            </div>
            <div>
